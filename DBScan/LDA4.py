...
# )
doc = get_deep_clean_word()
# 构造 tf-idf
tf_idf_vectorizer = TfidfVectorizer()
tf_idf = tf_idf_vectorizer.fit_transform(doc)
...
top_words_df.to_csv(top_words_csv_path, encoding='utf-8-sig', index=False)
...
# 保存文本主题概率分布到 csv 文件中
predict_df.to_csv(predict_topic_csv_path, encoding='utf-8-sig', index=False)
