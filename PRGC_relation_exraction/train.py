...
parser.add_argument('--multi_gpu', action='store_false', help="ensure multi-gpu training")
...
def train_and_evaluate(model, params, ex_params, restore_file=None):
    ...
    for epoch in range(1, args.epoch_num + 1):
        ...
        train_metrics = evaluate(args, model, train_loader, params, mark='Train')  # Dict['loss', 'f1']
